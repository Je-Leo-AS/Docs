...
\begin{itemize}
    ...
    \item A curva em verde representa o especto de frequência do amplificador ideal.
	...
	\begin{minipage}{0.5\textwidth}
		...
		\end{equation}
			$
				...
				=
				\begin{bmatrix}
					x(1) & x(0) & x(1)\lvert x(1) \rvert & x(0)\lvert x(0) \rvert \\ 
					x(2) & x(1) & x(2)\lvert x(2) \rvert & x(1)\lvert x(1) \rvert \\ 
					x(3) & x(2) & x(3)\lvert x(3) \rvert & x(2)\lvert x(2) \rvert \\ 
					x(4) & x(3) & x(4)\lvert x(4) \rvert & x(3)\lvert x(3) \rvert \\ 
					x(5) & x(4) & x(5)\lvert x(5) \rvert & x(4)\lvert x(4) \rvert
				\end{bmatrix}
				\begin{bmatrix}
					h_{1,0} \\
					h_{1,1} \\
