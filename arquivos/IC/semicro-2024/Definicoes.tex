...
\usepackage{titlesec} % ajuste de título e subtitulos mesmo diretório
...
\title{
    ...
    \end{minipage}\begin{minipage}[c]{0.7\textwidth} 
             \begin{center}
                ...
                \vspace{20pt}
                \Large
                  Leonardo de Andrade Santos\textsuperscript{1}, Sibilla Batista da Luz Franca\textsuperscript{1}, Eduardo Gonçalves de Lima\textsuperscript{2} \\
                  \normalsize
